...
<nav class="bg-purple-100 border-gray-200 px-4 lg:px-6 py-2.5 ">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <img src="../../assets/images/energym.png" class="h-8 me-3 scale-[2.5] pl-[2rem]" alt="energym Logo" />
                <div class="flex items-center lg:order-2">
                    <a href="../logout.php" class="text-gray-800 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 text-gray-700 ">Déconnexion</a>
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li>
                            <a href="#" class="block py-2 pr-4 pl-3 text-gray-700  rounded bg-primary-700 lg:bg-transparent lg:hover:bg-transparen lg:text-primary-700 lg:p-0 " aria-current="page">Home</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0   x²    ">Activités</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0   ">Réservations</a>
                        </li>
    ...
    <!-- Membres inscrits -->
    <h2 class="titre">Membres Inscrits</h2>
    <table>
        <thead>
            <tr>
                <th>Nom</th>
    ...
    <h2 class="titre">Réservations des Membres</h2>
    <table>
        <thead>
            <tr>
                <th>Nom</th>
    ...
    <h2 class="titre">Liste des Activités</h2>
    <table>
        <thead>
            <tr>
                <th>ID</th>
    ...
    <h2 class="titre">Gestion des Activités</h2>
    ...
    <footer class="bg-purple-100 w-full dark:bg-gray-900 bottom-0">
