...
<section class="bg-purple-100 dark:bg-gray-900 ">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img src="../assets/images/hero.png" alt="sport mockup">
        </div>
    </div>
</section>
...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Des services adaptés à votre salle de sport</h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">Optimisez la gestion de votre salle de sport avec des outils modernes et des fonctionnalités conçues pour répondre aux besoins de vos membres.</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Gestion des Abonnements</h3>
              <p class="text-gray-500 dark:text-gray-400">Simplifiez la gestion des abonnements de vos membres grâce à des outils intuitifs et automatisés.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Réservation de Cours</h3>
              <p class="text-gray-500 dark:text-gray-400">Permettez à vos membres de réserver facilement leurs cours en ligne et de consulter les plannings à tout moment.</p>
          </div>
          <div>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Gestion des Employés</h3>
              <p class="text-gray-500 dark:text-gray-400">Organisez les horaires et les responsabilités de vos coachs et employés en toute simplicité.</p>
          </div>
      </div>
  </div>
</section>
